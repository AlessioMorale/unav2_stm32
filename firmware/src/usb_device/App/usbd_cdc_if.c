...
static int8_t CDC_Init_FS(void) {
  ...
  cdcRxStream =
      xStreamBufferCreateStatic(sizeof(cdcRxBufferStorage), triggerLevel,
                                cdcRxBufferStorage, &cdcRxStreamBufferStruct);
...
static int8_t CDC_Receive_FS(uint8_t *Buf, uint32_t *Len) {
  ...
  /*size_t bytesSent = */
  xStreamBufferSendFromISR(cdcRxStream, (void *)Buf, len,
