...
#define COUNTERS_KEY_TABLE(ENTRY)                                                                                                                              \
  ...
  ENTRY(mc_loop_time, "McLoop", "Motor Controller", "Motor controller loop time", "uS", 1)                                                                     \
  ENTRY(sys_temp, "SysTemp", "System", "Temp", "deg", 1)                                                                                                       \
  ENTRY(sys_voltage, "SysVolt", "System", "V", "Volt", 1)                                                                                                      \
  ENTRY(sys_current, "SysCurr", "System", "I", "Amp", 1)                                                                                                       \
...
#define COUNTERS_INIT_COUNTER(x, y, ...) PERF_INIT_COUNTER(perf_##x, counters_##x##_key);
